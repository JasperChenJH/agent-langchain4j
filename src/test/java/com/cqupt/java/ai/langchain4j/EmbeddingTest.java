...
public class EmbeddingTest {
    ...
    public void testUploadKnowledgeLibrary() {
        ...
        //并使用默认的文档解析器对文档进行解析
        Document document1 = FileSystemDocumentLoader.loadDocument("F:/develop/knowledge/knowledge/重庆邮电大学医院信息.txt");
        Document document2 = FileSystemDocumentLoader.loadDocument("F:/develop/knowledge/knowledge/重庆邮电大学医院医生信息.txt");
        Document document3 = FileSystemDocumentLoader.loadDocument("F:/develop/knowledge/knowledge/重庆邮电大学介绍.txt");
